...
// import { Calendar, Clock, Phone, FileText, Building } from "lucide-react";
...
//             </Avatar>
//             <div>
//               <h4 className="font-semibold text-gray-800">{doctor?.name || "Doctor Name"}</h4>
//               <p className="text-gray-600 text-sm">{doctor?.specialty || "Specialty"}</p>
//             </div>
//           </div>
//         </div>
...
//                 <p className="font-medium">{patient.facility || "Main Clinic"}</p>
//               </div>
//             </div>
//           </div>
