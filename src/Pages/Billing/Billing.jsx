...
const Billing = () => {
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-r">
      <div className="flex flex-col items-center bg-white p-12 rounded-3xl shadow-xl max-w-md space-y-6 transform transition-all hover:scale-105 hover:shadow-3xl">
